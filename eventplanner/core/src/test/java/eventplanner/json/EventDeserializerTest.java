...
public class EventDeserializerTest {
    ...
    public void setup() {
        ...
        users.add(new User("christian@test.test", "password", true));
        users.add(new User("palina@test.test", "password", true));
        users.add(new User("david@test.test", "password", true));
        users.add(new User("thor@test.test", "password", true));
    ...
    public void testEventDeserialization() throws JsonMappingException, JsonProcessingException {
        ...
        //assertEquals(event2.getUsers(), result2.getUsers());
